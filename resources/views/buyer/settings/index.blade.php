            ...
            <div class="grid grid-cols-4 gap-x-3 max-w-7xl mx-auto">
                ...
                <div class="col-span-3">
                    ...
                    <div class="bg-[#F5F5F5] rounded-md pt-5 pb-5 mx-5" id="account-tab">
                        ...
                        <div class="mt-4 mx-5">
                            <form action="{{route('buyer.store.profile.settings')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="bg-[#F5F5F5] rounded-md pt-5 pb-5 mx-5 hidden" id="security-tab">
                        ...
                        <div class="mt-4 mx-5" id="security-phone-section">
                            <form action="" id="phone-verification-form">
                                <div class="grid grid-cols-3">
                                    <div class="col-span-1 mt-2">
                                    ...
                                    <div class="col-span-2">
                                        <input type="text" placeholder="Enter your number to verify" name="phone_number" id="phone_number"
                                            class="w-full py-2 pl-2 rounded-md">
                                ...
                                <div class="grid grid-cols-3 mt-3">
                                    ...
                                    <div class="col-span-2 mt-1">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" value="" class="sr-only peer" name="two_factor_authentication">
                                            <div
                    ...
                    <div class="bg-[#F5F5F5] rounded-md pt-5 pb-5 mx-5 hidden" id="notification-tab">
                                    ...
                                    <div class="col-span-2 mt-1">
                                        <div class="flex justify-between mx-14">
                                            ...
                                            <div class="">
                                                ...
                                                <ul class="text-[#575757] text-xs font-medium">
                                                    <li><input type="checkbox" name="inbox_messages" id="inbox_messages" @if($user->notification && $user->notification->inbox_message) checked @endif class="accent-[#C50000]" onclick="inboxMessageCheckbox()"></li>
                                                    <li><input type="checkbox" name="order_messages" id="order_messages" @if($user->notification && $user->notification->order_messages) checked @endif class="accent-[#C50000]" onclick="orderMessageCheckbox()"></li>
                                                    <li><input type="checkbox" name="order_updates" id="order_updates" @if($user->notification && $user->notification->order_updates) checked @endif class="accent-[#C50000]" onclick="orderUpdateCheckbox()"></li>
                                                    <li><input type="checkbox" name="rating_reminders" id="rating_reminders" @if($user->notification && $user->notification->rating_reminders) checked @endif class="accent-[#C50000]" onclick="ratingReminderCheckbox()"></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-4 mx-5">
                            <form id="notifications">
                                ...
                                <div class="flex justify-end mt-4">
                                    <button class="bg-[#C50000] text-white py-2 px-5 rounded-md" onclick="saveNotificationChanges()" type="button">Save
                                        Changes</button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        $('#order_updates').change(function() {
            if($(this).is(":checked")) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/buyer/order-update/notifications",
                    data: {
                        'check' : check
                    },
                    success: function(response) {
        ...
        $('#rating_reminders').change(function() {
            if($(this).is(":checked")) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/buyer/rating-reminder/notifications",
                    data: {
                        'check' : check
                    },
                    success: function(response) {
        ...
        function phoneVerification(){
            var formdata = new FormData($('#phone-verification-form')[0])
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.success == true){
                        Swal.fire({
                            icon: 'success',
                            title: 'SUCCESS...',
                            text: 'OTP sent on your email address successfully!',
                            backdrop: false,
                        }).then(function(){
                            window.location.reload();
                        });
                ...
                error: function(response) {
                    var response = JSON.parse(response.responseText);
                    $.each( response.errors, function( key, value) {
                        $('#security-phone-section #'+key+'-error').text(value)
                    });
                }
            });
        }
