		...
		<tbody>
			...
			<tr>
				<td class="p-100" style="margin-bottom: 20px">
					<h1 style="color: #fff; font-size: 34px; font-weight: bold; text-transform: uppercase; margin-bottom: 0px;">Hi,</h1>
				</td>
			</tr>
			<tr>
				<td class="p-100">
					<p style="color: #fff;">
                        The order-{{$emailData['orderId']}}  has been marked completed. <br> <br>
                        Order Start Date: {{$emailData['startDate']}} <br> <br>
                        Gig Title: {{$emailData['gig']}} <br> <br>
                        Order Amount(PKR): {{$emailData['orderAmount']}}
					</p>
				</td>
			</tr>
			<tr>
