        ...
        <nav>
            <div class="flex max-w-7xl nav justify-between mx-auto">
                ...
                <div class="nav-links flex mt-5 text-[#292929] font-medium">
                    ...
                    @else
                        <a href="" class="mx-5 hover:bg-[#C5000040] px-3 h-8 pt-1 rounded-md"><span>Orders</span></a>
                    @endrole
                    @auth
                        @role('Seller')
                    ...
                    @endauth
                    @auth
                        <a href="/chatify" class="mx-5 hover:bg-[#C5000040] px-3 h-8 pt-1 rounded-md"><span>Chat</span></a>
                    @endauth
                    @auth
                        @role('Seller')
                            <a href="{{route('settings.index')}}" class="mx-5 hover:bg-[#C5000040] px-3 h-8 pt-1 rounded-md"><span>Settings</span></a>
                        @else
                            <a href="" class="mx-5 hover:bg-[#C5000040] px-3 h-8 pt-1 rounded-md"><span>Settings</span></a>
                        @endrole
                    @endauth
                    @auth
