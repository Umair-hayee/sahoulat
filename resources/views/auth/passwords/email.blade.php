...
<head>
    ...
    <title>Forgot Password | Sahulat</title>
</head>
<body>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-side-login">
                        ...
                        <h3>No worries, we'll send you reset instructions</h3> <br>
                        @if (session('failure'))
                        ...
                        <div class="go-back">
                            <h3><a href="{{route('login')}}"><img src="{{asset('assets/imgs/go-back.png')}}" alt="">  Back to Sign In</a></h3>
