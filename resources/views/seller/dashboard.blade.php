            ...
            <div class="col-span-1">
                <div class="bg-[#F5F5F5] pt-5 pb-5 rounded-md mx-4">
                    <div class="flex justify-center">
                        <div class="">
                            <img src="{{ isset($user->image) ? asset($user->image) : asset('assets/imgs/19.lifestyle.png') }}"
                            ...
                            <div class="w-full">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="error text-red-500 font-bold-500 italic" id="sub_tag_id-modal-error">
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5">
